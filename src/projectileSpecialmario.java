...
public class projectileSpecialmario {
    String name;
    int xpos;
    int ypos;
    double dx;
    ...
    public projectileSpecialmario() {
        this.hitbox = new Rectangle(this.xpos, this.ypos, this.width, this.height);
    }

    public projectileSpecialmario(int xposInput, int yposInput, double dxInput, double dyInput, int widthInput, int heightInput) {
        this.xpos = xposInput;
        this.ypos = yposInput;
        this.dx = dxInput;
        this.dy = dyInput;
