...
public class projectile2mario {
    ...
    public projectile2mario() {
        this.hitbox = new Rectangle(this.xpos, this.ypos, this.width, this.height);
    }

    public projectile2mario(int xposInput, int yposInput, double dxInput, double dyInput, int widthInput, int heightInput) {
        this.xpos = xposInput;
        this.ypos = yposInput;
        this.dx = dxInput;
        this.dy = dyInput;
